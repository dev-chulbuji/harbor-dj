...
# harbor
curl -kL https://github.com/goharbor/harbor/releases/download/v$HARBOR_VERSION/harbor-offline-installer-v$HARBOR_VERSION.tgz -o $VENDOR_DIR/harbor-offline-installer-v$HARBOR_VERSION.tgz
